...
export type Department = 'student_affairs' | 'buses' | 'accounts' | 'results_control' | 'inventory' | 'principal' | 'owner'
...
export const DEPARTMENTS: DepartmentInfo[] = [
  ...
  { value: 'principal', labelAr: 'المدير', icon: '🏫', href: '/staff/principal', descAr: 'لوحة المتابعة اليومية — الحضور، الباصات، المالية، التنبيهات' },
